...
$JAVA_HOME/bin/keytool -genkey -validity 10000 -dname "CN=AndroidDebug, O=Android, C=US" -keystore $DEV_HOME/$APK_NAME.keystore -storepass android -keypass android -alias androidreleasekey -keyalg RSA -v -keysize 2048
else
